...
class Student {
    ...
    public Student(String fullName, String className, String parentName, String parentPhone) {
        this.fullName = fullName; this.className = className; 
...
class Result {
    ...
    public void calculateGradeAndDivision() {
        ...
        if (average >= 70) division = "Division One (Excellent)";
        else if (average >= 60) division = "Division Two (Very Good)";
        else if (average >= 50) division = "Division Three (Good)";
        else if (average >= 40) division = "Division Four (Satisfactory)";
        else division = "Division Zero (Fail)";
        totalMarks = total;
    }
...
class Invoice {
    private String id, studentId, studentName, description;
    private double amount, paidAmount = 0;
    private String date, status = "Pending";
    ...
    public double getRemainingAmount() { return amount - paidAmount; }
